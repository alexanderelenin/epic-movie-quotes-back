...
<body style="">
    <div style="background: linear-gradient(187.16deg, #181623 0.07%, #191725 51.65%, #0D0B14 98.75%);min-height:723px; ">
        ...
        <div style="text-align:start; margin-top:50px; margin-left: 5%;">
            ...
            <p style="font-family: sans-serif; sans-serif; font-size: 16px; color:white">Thanks for joining Movie quotes! We really appreciate it. Please click the button below to verify your account:</p> 
            <a 
                
                href="{{$url}}"
                >
                <button style="cursor: pointer; font-family: sans-serif; margin-top: 10px;  text-align:center; background-color:#E31221; border-radius:8px; border:none; color:white;padding: 15px; height:56px; font-size: 16px; text-decoration:none;" >Verify Account</button> 
            </a> 
            ...
            <a style="display:inline; width: 100%; white-space:normal" href="{{$url}}" > <p style="white-space:unset; color: #DDCCAA ; text-decoration: none; text-align:left;  padding-top:20px">{{$url}}</p> </a>
